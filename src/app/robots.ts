 ...
 * while the site still carries placeholder content (drafted testimonial
 * quotes, invented entry requirements) alongside WIPEG's real name, accreditation number
